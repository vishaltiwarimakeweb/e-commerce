...
- `AGENTS.md` and `CLAUDE.md` show as modified in `git status` from *before* this session started — not touched by this work, left alone per the mandatory "don't change CLAUDE.md" rule.
